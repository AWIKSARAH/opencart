            ...
            <div class="tab-pane" id="tab-links">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="" name="manufacturer_id" value="<?php echo $manufacturer_id; ?>" />
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="" name="seller_id" value="<?php echo $seller_id; ?>" />
                </div>
                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tax-class"><?php echo $entry_tax_class; ?></label>
                <div class="col-sm-10">
...
$('input[name=\'seller\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/seller/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				json.unshift({
					seller_id: 0,
