...
<script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha384-KyZXEAg3QhqLMpG8r+Knujsl5/2+8OwE/DAjweaP6KL1iKZfG5bFfDkEElcjZ7xj" crossorigin="anonymous"></script>

<!-- Slim build (excludes ajax and effects modules) -->
<script src="https://code.jquery.com/jquery-3.6.0.slim.min.js" integrity="sha384-KyZXEAg3QhqLMpG8r+Knujsl5/2+8OwE/DAjweaP6KL1iKZfG5bFfDkEElcjZ7xj" crossorigin="anonymous"></script>

<!-- Full version (includes ajax and effects modules) -->
<script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha384-KyZXEAg3QhqLMpG8r+Knujsl5/2+8OwE/DAjweaP6KL1iKZfG5bFfDkEElcjZ7xj" crossorigin="anonymous"></script>
