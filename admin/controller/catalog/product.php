...
class ControllerCatalogProduct extends Controller
{
	...
	protected function getForm()
	{
		...
		$data['help_sellrer'] = $this->language->get('help_sellrer');
		...
		if (isset($this->request->post['seller'])) {
			...
			$seller_info = $this->model_catalog_seller->getSeller($product_info['seller_id']);

			if ($seller_info) {
				$data['seller'] = $seller_info['name'];
			} else {
				$data['seller'] = '';
			}
		} else {
	...
	public function autocomplete()
	{
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
			...
			foreach ($results as $result) {
				...
				// Check if manufacturer information is available
				$manufacturer_name = '';
				if ($manufacturer_info) {
				...
				$json[] = array(
					...
					'model' => $result['model'],
					'option' => $option_data,
					'manufacturer' => $manufacturer_name, // Include manufacturer name
					'price' => $result['price']
				);
			}
		}
